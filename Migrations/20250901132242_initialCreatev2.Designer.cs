...
namespace FraudDetectorWebApp.Migrations
{
    ...
    [Migration("20250901132242_initialCreatev2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FraudDetectorWebApp.Models.AdminActionLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AdminUserId", "ActionAt");
            ...
            modelBuilder.Entity("FraudDetectorWebApp.Models.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FraudDetectorWebApp.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FraudDetectorWebApp.Models.RolePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FraudDetectorWebApp.Models.UserPermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FraudDetectorWebApp.Models.UserRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FraudDetectorWebApp.Models.AdminActionLog", b =>
                {
                    b.HasOne("FraudDetectorWebApp.Models.User", "AdminUser")
            ...
            modelBuilder.Entity("FraudDetectorWebApp.Models.RolePermission", b =>
                {
                    b.HasOne("FraudDetectorWebApp.Models.User", "AssignedBy")
                        .WithMany()
                        .HasForeignKey("AssignedByUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("FraudDetectorWebApp.Models.Permission", "Permission")
                        .WithMany("RolePermissions")
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FraudDetectorWebApp.Models.Role", "Role")
                        .WithMany("RolePermissions")
