        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResourcePath = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RolePermissions_Users_AssignedByUserId",
                        column: x => x.AssignedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdminActionLogs_ActionAt",
                table: "AdminActionLogs",
                column: "ActionAt");

            migrationBuilder.CreateIndex(
                name: "IX_AdminActionLogs_AdminUserId_ActionAt",
                table: "AdminActionLogs",
                columns: new[] { "AdminUserId", "ActionAt" });

            migrationBuilder.CreateIndex(
                name: "IX_AdminActionLogs_IsSuccessful",
                table: "AdminActionLogs",
                column: "IsSuccessful");

            migrationBuilder.CreateIndex(
                name: "IX_AdminActionLogs_TargetType",
                table: "AdminActionLogs",
                column: "TargetType");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Permissions_ResourcePath",
                table: "Permissions",
                column: "ResourcePath");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolePermissions_AssignedByUserId",
                table: "RolePermissions",
